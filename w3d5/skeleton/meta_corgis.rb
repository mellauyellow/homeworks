...
class MetaCorgiPerkPackage
  ...
  #   info = @shopping_list.send("get_#{method_name}_info", @package_id)
  #   happiness = @shopping_list.send("get_#{method_name}_happiness", @package_id)
  #   result = "#{method_name}: #{info}: #{happiness} licks"
  #   happiness > 30 ? "* #{result}" : result
  # end
